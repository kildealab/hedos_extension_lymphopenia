...
#This code was simply to plot figures
...
def plot_dvh_for_roi(ax, rs_muhc, rd_muhc, rs_lymphotec, rd_lymphotec, roi_name):
    """
    This function plots DVHs comparing the before and after optimization for specified organs, as well as constraints
    in order to compare the optimization.
    """
    ...
    # Add arrow markers to define objectives
...
fig.savefig("dvh_comparison.pdf", bbox_inches="tight")          # best for papers
fig.savefig("dvh_comparison.png", dpi=300, bbox_inches="tight") # optional
plt.show()
...
# helper: add panel labels in TOP-RIGHT
...
# weights so each histogram sums to 100%
...
# Figure 2 — Global y-limit (for fair comparison)
global_max = 0.0
